...
checkpoint:
  ...
  gray_areas_resolved:
    - topic: "pain category"
      decision: "koordynacja / narzut organizacyjny — ręczne układanie grafiku koni i godzin"
    - topic: "primary persona"
      decision: "ośrodek (admin/instruktor); jeździec jest stroną popytową"
    - topic: "insight"
      decision: "przydział koni to reguła alokacji zasobu z limitami; małe nietechniczne stadniny; dziś koordynacja telefoniczna; dane z zajęć nigdzie nie trafiają"
    - topic: "auth strategy"
      decision: "e-mail + hasło; dwie role: Ośrodek (admin) + Jeździec"
  frs_drafted: 9
  quality_check_status: accepted
---

# Shape Notes — Stable Booksy

Greenfield. Aplikacja do zapisów na jazdy konne w stadninach, zastępująca ręczny kalendarz i ręczne przydzielanie koni do godzin.
...
Dwie role:
- **Ośrodek (admin)** — administruje swoją stadniną: ustawia konie pracujące w danym dniu, zakres godzin pracy ośrodka (np. 10–16), przyjmuje/widzi zapisy, prowadzi statystyki i komentarze do zajęć.
...
- **Statystyki zajęć, komentarze i analiza AI** — poza v1; zaplanowane na v2 (decyzja scope-down z Fazy 3: leżą poza pętlą rezerwacji, którą udowadnia MVP).
