...
- **S-01: użytkownik może zarejestrować konto jako Ośrodek albo Jeździec, zalogować się e-mailem i hasłem i trafić do widoku właściwego dla swojej roli.** — Archived 2026-08-19 → `context/archive/2026-08-10-role-aware-auth/`. Lesson: —.
